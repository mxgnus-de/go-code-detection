...
func TestCPPHelloWorldLanguageDetection(t *testing.T) {
	t.Log("Testing C++ Hello World Language Detection")
	code := `cout << \"Hello world\" << endl;`
	result := detection.DetectLanguage(code, detection.NewDetectionOptions())

	if result.Language != language.LANGUAGE_CPP {
		t.Errorf("Expected language to be %s, got %s", language.LANGUAGE_CPP, result.Language)
		t.Errorf("Result: %v", result)
	}
}

func TestCPPfizzBuzzLanguageDetection(t *testing.T) {
...
func TestCPPQuickSortLanguageDetection(t *testing.T) {
...
func TestCPPBubbleSortLanguageDetection(t *testing.T) {
	t.Log("Testing C++ BubbleSort Language Detection")
...
func TestCPPHeapSortLanguageDetection(t *testing.T) {
	t.Log("Testing C++ HeapSort Language Detection")
	code := `#include <algorithm>
   #include <iterator>
   #include <iostream>
...
func TestCPPHttpServerLanguageDetection(t *testing.T) {
	t.Log("Testing C++ HttpServer Language Detection")
...
func TestCPPFloydWarshallAlgorithmLanguageDetection(t *testing.T) {
	t.Log("Testing C++ FloydWarshallAlgorithm Language Detection")
...
func TestCPPLudicNumbersLanguageDetection(t *testing.T) {
	t.Log("Testing C++ LudicNumbers Language Detection")
	code := `#include <vector>
   #include <iostream>
   using namespace std;
...
func TestCPPHappyNumbersLanguageDetection(t *testing.T) {
	t.Log("Testing C++ HappyNumbers Language Detection")
	code := `#include <map>
   #include <set>
...
func TestCPPGammaFunctionLanguageDetection(t *testing.T) {
	t.Log("Testing C++ GammaFunction Language Detection")
	code := `#include <math.h>
   #include <numbers>
   #include <stdio.h>
   #include <vector>
...
func TestCPPFivenumLanguageDetection(t *testing.T) {
...
func TestCPPYCombinatorLanguageDetection(t *testing.T) {
