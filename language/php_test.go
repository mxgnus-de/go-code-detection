...
func TestPHPHelloWorldLanguageDetection(t *testing.T) {
	t.Log("Testing PHP Hello World Language Detection")
...
func TestPHPFizzBufferLanguageDetection(t *testing.T) {
	t.Log("Testing PHP FizzBuzz Language Detection")
	code := `<?php
...
func TestPHPSQLBasedAuthenticationLanguageDetection(t *testing.T) {
	t.Log("Testing PHP SQL Based Authentication Language Detection")
	code := `function connect_db($database, $db_user, $db_password, $host = 'localhost', $port = NULL, $die = false) {
...
func TestPHPQuickSortLanguageDetection(t *testing.T) {
	t.Log("Testing PHP Quick Sort Language Detection")
...
func TestPHPBubbleSortLanguageDetection(t *testing.T) {
	t.Log("Testing PHP Bubble Sort Language Detection")
...
func TestPHPIMergeSortLanguageDetection(t *testing.T) {
	t.Log("Testing PHP Iterative Merge Sort Language Detection")
...
func TestPHPBogoSortLanguageDetection(t *testing.T) {
	t.Log("Testing PHP Bogo Sort Language Detection")
	code := `function bogosort($l) {
      while (!in_order($l))
          shuffle($l);
      return $l;
  }
...
func TestPHPFloydWarshallAlgorithmLanguageDetection(t *testing.T) {
	t.Log("Testing PHP Floyd-Warshall Algorithm Language Detection")
	code := `<?php
   $graph = array();
   for ($i = 0; $i < 10; ++$i) {
         $graph[] = array();
