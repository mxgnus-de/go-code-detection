...
func TestPascalHelloWorldLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal Hello World Language Detection")
   ...
   begin
	...
	if result.Language != language.LANGUAGE_PASCAL {
		t.Errorf("Expected language to be %s, but got %s", language.LANGUAGE_PASCAL, result.Language)
		t.Errorf("Result: %v", result)
	}
}

func TestPascalFizzBuzzLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal FizzBuzz Language Detection")
	code := `program fizzbuzz(output);
   var
      i: integer;
   begin
      for i := 1 to 100 do
...
func TestPascalGuessTheNumberLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal Guess The Number Language Detection")
	code := `Program GuessTheNumber(input, output);
...
func TestPascalBubbleSortLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal Bubble Sort Language Detection")
	code := `procedure bubble_sort(var list: array of real);
   var
      i, j, n: integer;
      t: real;
   begin
...
func TestPascalHeapSortLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal Heap Sort Language Detection")
	code := `program HeapSortDemo;
...
func TestPascalMergeSortLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal Merge Sort Language Detection")
	code := `program MergeSortDemo;
...
func TestPascalQuickSortLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal Quick Sort Language Detection")
	code := `{ X is array of LongInt }
...
func TestPascalPalindromeLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal Palindrome Language Detection")
	code := `program Palindro;
...
func TestPascalHappyNumbersLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal Happy Numbers Language Detection")
...
func TestPascalLudicNumbersLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal Ludic Numbers Language Detection")
	code := `program lucid;
   {$IFDEF FPC}
...
func TestPascalAttractiveNumbersLanguageDetection(t *testing.T) {
	t.Log("Testing Pascal Attractive Numbers Language Detection")
	code := `program AttractiveNumbers;
   ...
   * of the composite number }
   ...
   Begin
	...
	if result.Language != language.LANGUAGE_PASCAL {
		t.Errorf("Expected %s, got %s", language.LANGUAGE_PASCAL, result.Language)
		t.Errorf("Result: %v", result)
	}
}
