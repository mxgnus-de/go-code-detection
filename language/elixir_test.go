...
func TestElixirHelloWorldLanguageDetection(t *testing.T) {
	t.Log("Testing Elixir Hello World Language Detection")
	code := `IO.puts :stderr, "Goodbye, World!"`
	result := detection.DetectLanguage(code, detection.NewDetectionOptions())

	if result.Language != language.LANGUAGE_ELIXIR {
		t.Errorf("Expected language to be %s, but got %s", language.LANGUAGE_ELIXIR, result.Language)
		t.Errorf("Result: %v", result)
	}
}

func TestElixirFizzBuzzLanguageDetection(t *testing.T) {
	t.Log("Testing Elixir FizzBuzz Language Detection")
...
func TestElixirAnagramsLanguageDetection(t *testing.T) {
	t.Log("Testing Elixir Anagrams Language Detection")
	code := `defmodule Anagrams do
   def find(file) do
      File.read!(file)
      |> String.split
...
func TestElixirBubbleSortLanguageDection(t *testing.T) {
	t.Log("Testing Elixir Bubble Sort Language Detection")
...
func TestElixirHeapSortLanguageDetection(t *testing.T) {
	t.Log("Testing Elixir Heap Sort Language Detection")
	code := `defmodule Sort do
...
func TestElixirMergeSortLanguageDetection(t *testing.T) {
	t.Log("Testing Elixir Merge Sort Language Detection")
	code := `defmodule Sort do
...
func TestElixirQuickSortLanguageDetection(t *testing.T) {
	t.Log("Testing Elixir Quick Sort Language Detection")
	code := `defmodule Sort do
   def qsort([]), do: []
   def qsort([h | t]) do
...
func TestElixirLudicNumbersLanguageDetection(t *testing.T) {
	t.Log("Testing Elixir Ludic Numbers Language Detection")
	code := `defmodule Ludic do
...
func TestElixirHappyNumbersLanguageDetection(t *testing.T) {
	t.Log("Testing Elixir Happy Numbers Language Detection")
...
func TestElixirFloydWarshallLanguageDetection(t *testing.T) {
	t.Log("Testing Elixir Floyd Warshall Language Detection")
	code := `defmodule Floyd_Warshall do
   def main(n, edge) do
