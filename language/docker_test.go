...
func TestDockerfileTeknumBotLanguageDetection(t *testing.T) {
	t.Log("Testing Dockerfile Teknum Bot Language Detection")
	code := `
   ...
   CMD ["npm", "start"]`
	...
	if result.Language != language.LANGUAGE_DOCKERFILE {
		t.Errorf("Expected language to be %s, but got %s", language.LANGUAGE_DOCKERFILE, result.Language)
		t.Errorf("Result: %v", result)
	}
}

func TestDockerfileBotnetLanguageDetection(t *testing.T) {
	t.Log("Testing Dockerfile Botnet Language Detection")
	code := `
...
func TestDockerfileCaspherjsLanguageDetection(t *testing.T) {
	t.Log("Testing Dockerfile Caspherjs Language Detection")
	code := `
   #
...
func TestDockerfileKafkaLanguageDetection(t *testing.T) {
	t.Log("Testing Dockerfile Kafka Language Detection")
	code := `
