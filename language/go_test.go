...
func TestGoHelloWorldLanguageDetection(t *testing.T) {
	t.Log("Testing Go Hello World Language Detection")
	code := `fmt.Println(\"Hello world\")`
	result := detection.DetectLanguage(code, detection.NewDetectionOptions())

	if result.Language != language.LANGUAGE_GO {
		t.Errorf("Expected language to be %s, but got %s", language.LANGUAGE_GO, result.Language)
		t.Errorf("Result: %v", result)
	}
}
func TestGoFizzBuzzLanguageDetection(t *testing.T) {
	t.Log("Testing Go FizzBuzz Language Detection")
	code := `package main
...
func TestGoQuickSortLanguageDetection(t *testing.T) {
	t.Log("Testing Go QuickSort Language Detection")
	code := `package main
...
func TestGoHttpServerLanguageDetection(t *testing.T) {
	t.Log("Testing Go Http Server Language Detection")
	code := `package main
...
func TestGoBubbleSortLanguageDetection(t *testing.T) {
	t.Log("Testing Go Bubble Sort Language Detection")
	code := `package main
...
func TestGoHeapSortLanguageDetection(t *testing.T) {
	t.Log("Testing Go Heap Sort Language Detection")
	code := `package main
...
func TestGoFloydWarshallAlgorithmLanguageDetection(t *testing.T) {
	t.Log("Testing Go Floyd Warshall Algorithm Language Detection")
	code := `package main
...
func TestGoLudicNumbersLanguageDetection(t *testing.T) {
	t.Log("Testing Go Ludic Numbers Language Detection")
	code := `package main
...
func TestGoGammaFunctionLanguageDetection(t *testing.T) {
	t.Log("Testing Go Gamma Function Language Detection")
	code := `package main
...
func TestGoFivenumLanguageDetection(t *testing.T) {
	t.Log("Testing Go Fivenum Language Detection")
	code := `package main
...
func TestGoYCombinatorLanguageDetection(t *testing.T) {
	t.Log("Testing Go Y Combinator Language Detection")
	code := `package main
