...
func TestCHelloWorldLanguageDetection(t *testing.T) {
	t.Log("Hello World language test detection for C language")
   ...
   int main(void) {
	...
	if result.Language != language.LANGUAGE_C {
		t.Errorf("Expected language to be %s, but was %s", language.LANGUAGE_C, result.Language)
		t.Errorf("Result: %v", result)
	}

}

func TestCFizzBuzzLanguageDetection(t *testing.T) {
	t.Log("FizzBuzz language test detection for C language")
	code := `#include <stdio.h>
...
func TestCVariableDeclarationLanguageDetection(t *testing.T) {
	t.Log("Variable declaration language test detection for C language")
	code := `int *ptr;`
	result := detection.DetectLanguage(code, detection.NewDetectionOptions())
...
func TestCFileLanguageDetection(t *testing.T) {
	t.Log("File language test detection for C language")
	code := `static int IndexEntry__set_mtime__meth(lua_State *L) {
...
func TestCQuickSortLanguageDetection(t *testing.T) {
	t.Log("Quick sort language test detection for C language")
	code := `#include <stdio.h>
...
func TestCHttpServerLanguageDetection(t *testing.T) {
	t.Log("Http server language test detection for C language")
	code := `#include <stdio.h>
   #include <stdlib.h>
   #include <curl/curl.h>
...
func TestCFibonacciSequenceLanguageDetection(t *testing.T) {
	t.Log("Fibonacci sequence language test detection for C language")
	code := `long long int fibb(int n) {
...
func TestCBubbleSortLanguageDetection(t *testing.T) {
	t.Log("Bubble sort language test detection for C language")
	code := `#include <stdio.h>
...
func TestCHeapSortLanguageDetection(t *testing.T) {
	t.Log("Heap sort language test detection for C language")
	code := `#include <stdio.h>
...
func TestCTreeSortLanguageDetection(t *testing.T) {
	t.Log("Tree sort language test detection on a linked list for C language")
	code := `#include <stdio.h>
   #include <stdlib.h>
   #include <time.h>
...
func TestCFloydWarshallAlgorithmLanguageDetection(t *testing.T) {
	t.Log("Floyd-Warshall algorithm language test detection on a linked list for C language")
...
func TestCLudicNumbersLanguageDetection(t *testing.T) {
	t.Log("Ludic numbers language test detection on a linked list for C language")
	code := `#include <stdio.h>
   #include <stdlib.h>
