...
func TestCSHelloWorldLanguageDetection(t *testing.T) {
	t.Log("Testing C# Hello World Language Detection")
	code := `using System;
   Console.WriteLine("Hello world!");`
	result := detection.DetectLanguage(code, detection.NewDetectionOptions())

	if result.Language != language.LANGUAGE_CS {
		t.Errorf("Expected language to be %s, but got %s", language.LANGUAGE_CS, result.Language)
		t.Errorf("Result: %v", result)
	}
}

func TestCSFizzBuzzLanguageDetection(t *testing.T) {
	t.Log("Testing C# FizzBuzz Language Detection")
	code := `class Program
   {
...
func TestCSQuickSortLanguageDetection(t *testing.T) {
	t.Log("Testing C# QuickSort Language Detection")
	code := `//
...
func TestCSHeapSortLanguageDetection(t *testing.T) {
	t.Log("Testing C# Heap Sort Language Detection")
	code := `using System;
...
func TestCSBubbleSortLanguageDetection(t *testing.T) {
	t.Log("Testing C# Bubble Sort Language Detection")
	code := `using System;
   using System.Collections.Generic;
...
func TestCSMergeSortLanguageDetection(t *testing.T) {
	t.Log("Testing C# Merge Sort Language Detection")
	code := `namespace RosettaCode {
      using System;
...
func TestCSFibonacciSequenceLanguageDetection(t *testing.T) {
	t.Log("Testing C# Fibonacci Sequence Language Detection")
	code := `public static IEnumerable<long> Fibs(uint x) {
...
func TestCSHappyNumbersLanguageDetection(t *testing.T) {
	t.Log("Testing C# Happy Numbers Language Detection")
	code := `using System;
   using System.Collections.Generic;
   using System.Linq;
   using System.Text;
...
func TestCSGammaFunctionLanguageDetection(t *testing.T) {
	t.Log("Testing C# Gamma Function Language Detection")
	code := `using System;
...
func TestCSFivenumLanguageDetection(t *testing.T) {
	t.Log("Testing C# Fivenum Language Detection")
	code := `using System;
   using System.Collections.Generic;
   using System.Linq;
   using System.Text;
...
func TestCSYCombinatorLanguageDetection(t *testing.T) {
	t.Log("Testing C# Y Combinator Language Detection")
	code := `using System;
...
func TestCSQuickSortWithJavaConflictLanguageDetection(t *testing.T) {
	t.Log("Testing C# QuickSort With Java Conflict Language Detection")
	code := `namespace ConsoleApplication13
   {
         class Program
         {
            static void Main(string[] args)
