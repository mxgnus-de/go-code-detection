...
func TestJuliaHelloWorldLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Hello World Language Detection")
	code := `println("Hello world!")`
	result := detection.DetectLanguage(code, detection.NewDetectionOptions())

	if result.Language != language.LANGUAGE_JULIA {
		t.Errorf("Expected language to be %s, but got %s", language.LANGUAGE_JULIA, result.Language)
		t.Errorf("Result: %v", result)
	}
}

func TestJuliaFizzBuzzLanguageDetection(t *testing.T) {
	t.Log("Testing Julia FizzBuzz Language Detection")
	code := `for i in 1:100
      if i % 15 == 0
         println("FizzBuzz")
      elseif i % 3 == 0
...
func TestJuliaFicbonacciSequenceLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Ficbonacci Sequence Language Detection")
	code := `function fib(n)
      x,y = (0,1)
...
func TestJuliaHttpServerLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Http Server Language Detection")
	code := `using HttpServer
...
func TestJuliaPalindromeDetectionLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Palindrome Detection Language Detection")
...
func TestJuliaQuickSortLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Quick Sort Language Detection")
	code := `function quicksort!(A,i=1,j=length(A))
      if j > i
...
func TestJuliaBubbleSortLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Bubble Sort Language Detection")
	code := `function bubblesort!(arr::AbstractVector)
...
func TestJuliaHeapSortLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Heap Sort Language Detection")
	code := `function swap(a, i, j)
      a[i], a[j] = a[j], a[i] 
   end
...
func TestJuliaTreeSortOnLinkedListLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Tree Sort On Linked List Language Detection")
	code := `mutable struct BTree{T}
      data::T
...
func TestJuliaLudicNumbersLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Ludic Numbers Language Detection")
	code := `function ludic_filter{T<:Integer}(n::T)
...
func TestJuliaFloydWarshallAlgorithmLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Floyd-Warshall Algorithm Language Detection")
	code := `# Floyd-Warshall algorithm: https://rosettacode.org/wiki/Floyd-Warshall_algorithm
   # v0.6
...
func TestJuliaFivenumLanguageDetection(t *testing.T) {
	t.Log("Testing Julia Fivenum Language Detection")
	code := `function mediansorted(x::AbstractVector{T}, i::Integer, l::Integer)::T where T
   len = l - i + 1
